...
class EventController extends Controller
{
    ...
    public function createAction()
    {
        ...
        $locationForm = $this->createFormBuilder(new Location())
            ->add('city', 'text')
            ->add('address', 'text')
            ->add('latitude', 'text')
            ->add('longitude', 'text')
            ->getForm();
        $routeForm = $this->createFormBuilder(new LocationRoute())
            ->add('location', 'collection', ['type' => $locationForm, 'allow_add' => true])
            ->getForm();
        $form = $this->createFormBuilder(new Event())
            ->add('title', 'text')
